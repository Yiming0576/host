...
import { BackgroundGradientAnimation } from "@/components/ui/BentoGrid/BackgroundGradientAnimation";
import GridGlobe from "@/components/ui/BentoGrid/GridGlobe";
import animationData from "@/data/confetti.json";
import MagicButton from "@/components/ui/Hero/MagicButton/Magicbutton";
...
export const BentoGridItem = ({
  ...
  const programmingLanguages = skills[0].Languages; // Access Languages
  const frameworks = skills[0].Frameworks; // Access Frameworks
  const databases = skills[0].Databases; // Access Databases
  ...
  const MagicButtonPropsData: MagicButtonProps = {
